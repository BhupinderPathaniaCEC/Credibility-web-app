...
### 📄 API Documentation - Registration Endpoint
POST /api/User/register

**Description:** Handles new user account creation. This endpoint validates the incoming data, ensures the email is unique within the system, secures the password using BCrypt hashing, and persists the user to the database.
...
| displayName | string | Yes      | Cannot be empty.                    |
